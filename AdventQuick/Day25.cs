...
Although it hasn't changed, you can still get your puzzle input.
    ...
    public class Day25
    {
        private static long modulo = 20201227;
        public static void Main(string[] arg)
        {
            //long cardPK = 19241437;
            //long roomPK = 17346587;
            //long cardPK = 5764801;
            //long roomPK = 17807724;
            Console.WriteLine(solve(5764801, 17807724));
            Console.WriteLine(solve(19241437, 17346587));
        }

        private static long solve(long cardPK, long roomPK)
        {
            int cardloop = -1;
            int roomloop = -1;
            int i = 1;
            ...
            if (cardloop < roomloop)
            {
                return compute(roomPK, cardloop);
            }
            else
                return compute(cardPK, roomloop);
        }

        private static long compute(long subject, int loop)
        {
            long current = subject;
